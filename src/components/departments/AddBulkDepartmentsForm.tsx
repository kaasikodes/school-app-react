...
import {
  downloadBulkDepartmentUploadTemplate,
...
const AddBulkDepartmentsForm: React.FC<IProps> = ({ closeDrawer }) => {
    ...
    <div className="flex flex-col gap-6">
      <div className="border border-dotted border-slate-500 rounded flex flex-col items-center gap-2 py-3 px-2">
        ...
        <Typography.Text title="Please Download template and populate">
          <a href={downloadBulkDepartmentUploadTemplate()}>
...
export default AddBulkDepartmentsForm;
